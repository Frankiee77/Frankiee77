...
void pilih(){
    ...
    if (pilihan==1){
        short clss[3] = {1, 2, 3};
        string kls[3] = {". First class", ". Bussiness class", ". Economy class"};
        string dari, ke;
        short kelas;
        unsigned short tgl1, tgl3;
        string tgl2;
        short pnpg1, pnpg2, pnpg3;
        system ("cls");
        cout << "<><><><><><><><><><><><><>" << endl;
        ...
        cout << "Keberangkatan" << endl;
            ...
            for (int i = 0; i < 3; i++)
            {
                cout << clss[i] << kls[i] << endl;
            }
            cout << "Pilih kelas mana yang akan dipilih : ";
            cin >> kelas; cout << endl;
        cout << "Penumpang" << endl;
            cout << "Dewasa \t: "; cin >> pnpg1;
            cout << "Anak \t: "; cin >> pnpg2;
            cout << "Balita \t: "; cin >> pnpg3;
    }
    else if(pilihan==2){
        short clss[3] = {1, 2, 3};
        string kls[3] = {". First class", ". Bussiness class", ". Economy class"};
       ...
       short clss[2] = {1, 2};
        string kls[2] = {". Express class", ". Reguler class"};
        string dari, ke;
        short kelas;
        unsigned short tgl1, tgl3;
        string tgl2;
